import {
  useTheme,
  ThemeProvider,
} from "./components/calendar/theme/ThemeContext";
...
const AppContent: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen ${bodyBgClass} ${bodyTextClass} font-${theme.typography.fontFamily} antialiased transition-colors duration-300 ease-in-out`}
    >
      <div className="fixed top-3 right-3 md:top-4 md:right-4 z-[60] flex items-center space-x-2 md:space-x-3 p-2 bg-opacity-60 backdrop-blur-md bg-slate-100/70 dark:bg-slate-800/70 rounded-lg shadow-lg">
        ...
        <div className="relative">
          ...
          <div
            className={`pointer-events-none absolute inset-y-0 right-0 flex items-center px-1 md:px-2 text-${theme.colors.textSecondary}`}
          >
            <svg
