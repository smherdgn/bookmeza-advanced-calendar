...
// CRITICAL: Ensure these paths are relative (start with './')
...
i18n
  ...
  .init({
    ...
    lng: typeof window !== 'undefined' ? localStorage.getItem('i18nextLng') || navigator.language.split('-')[0] || 'en' : 'en', // default language
